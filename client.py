    ...
    def fetch_pool(self, version_id: str, project_id: str) -> dict:
        ...
        data = self._get(
            params={
                ...
                "pri": "", "desc": "",
                "reviewPool": "", "skins": "", "deptCenter": "",  # 必须携带（空字符串）
                "timeType": "timeType1",                           # 关键必须参数
        ...
        while True:
            data = self._get(
                params={
                    ...
                    "version": version_id, "mode": "1",  # mode=2 已废弃
                    "handleDept": "0", "dept": "0",

...
未明确指定项目时，默认生成**平台项目**日报；只有你明确说了**平台项目+游戏项目**时，才会分别输出双项目内容。
...
未明确指定项目时，自由查询也默认按**平台项目**处理；如果要查游戏项目，需显式说“游戏项目”，如果要双项目，需显式说“平台项目+游戏项目”。
...
| 场景              | 状态   | 触发方式                              | 报告保存位置           |
| --------------- | ---- | --------------------------------- | ---------------- |
| 日报              | ✅ 可用 | "帮我出今天的日报"（默认平台项目）                | 报告/日报/           |
| 自由问答（版本/Bug/需求） | ✅ 可用 | 直接提问（默认平台项目）                      | —                |
...
> 说明：除周汇总/周报固定双项目外，其余场景未指定项目时默认按**平台项目**处理。
